...
const about = {
    ...
    info: [
        {
            fieldName: "Name",
            fieldValue: "Nguyen Van Tinh"
        },
        {
            fieldName: "Phone",
            fieldValue: "(+84) 387 64 0547"
        },
        {
        ...
        {
            fieldName: "MS Teams",
            fieldValue: "nguyentinh03032000@gmail.com"
        },
        {
        ...
        {
            fieldName: "Email",
            fieldValue: "nguyenvantinh0547@gmail.com"
        },
        {
            fieldName: "Freelance",
                                    ...
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {experience.items.map((item, index) => {
                                            return (
                                                ...
                                                justify-center items-center lg:items-star gap-1">
                                    ...
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {education.items.map((item, index) => {
                                            return (
                                                ...
                                                justify-center items-center lg:items-star gap-1">
                                                    <span className="text-accent">{item.duration}</span>
                                                    <h3 className="text-xl max-w-[264px] min-h-[60px] text-center lg:text-left">
                                                        {item.degree}
                                                    </h3>
                                                    <div className="flex items-center gap-3">
                                                        {/* dot */}
